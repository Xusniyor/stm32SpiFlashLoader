...
//{
//	// 16bit mode
//	if((sFLASH_SPI->CR1 & ((uint16_t)0x400)) == RESET)
//	{
//		sFLASH_SPI->CR1 |= (uint16_t)0x400;
//	}
//	/*!< Loop while DR register in not emplty */
//	while ((sFLASH_SPI->SR & ((uint16_t)0x0002)) == RESET);
//
//	/*!< Send Half Word through the sFLASH peripheral */
//	sFLASH_SPI->DR = HalfWord;
//
//	/*!< Wait to receive a Half Word */
//	while ((sFLASH_SPI->SR & ((uint16_t)0x0001)) == RESET);
//
